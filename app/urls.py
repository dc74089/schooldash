...
urlpatterns = [
    ...
    path('eink', views.eink_image, name='eink'),
    path('eink/html', views.eink_html, name='eink_page'),
    ...
    path('dev/sy', views.dashboard, name='dev_sy'),
    path('dev/summer', views.summer, name='dev_summer'),
